import os
import pickle
dir_path = r"G:\Other computers\My Laptop\Doctoral program\Lab\NER dataset\CTI-reports-dataset-master\data\CTI reports"
file_path = r"G:\Other computers\My Laptop\Doctoral program\Lab\NER dataset\DNRTI\train.txt"
save_file = os.path.join(r"C:\Users\Oblivion\Working Space\miscellaneous\CTI_reports\output", r"cti_report.pickle")
